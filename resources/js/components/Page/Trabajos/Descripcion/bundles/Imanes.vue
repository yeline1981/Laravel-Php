<template>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group row justify-content-center">
            <label class="col-md-2 col-form-label" for="pa_formato">Tipo *</label>
            <div class="col-md-6">
                <select id="pa_formato" class="form-control" v-model="papel" data-show_option_none="yes">
                    <option value="" disabled>Seleccioná</option>
                    <option value="Redondo">Brillante</option>
                    <option value="Cuadrado">Mate</option>
                </select>
            </div>
        </div>

        <div class="form-group row justify-content-center">
            <label class="col-md-2 col-form-label" for="pa_formato">Formato *</label>
            <div class="col-md-6">
                <select id="pa_formato" class="form-control" v-model="formato">
                    <option value="" disabled>Seleccione</option>
                    <option value="6x5 cms">6x5 cms</option>
                    <option value="30x60 cms">30x60 cms</option>
...
export default {
    ...
    created(){
        ...
        EventBus.$on('Crear_Imanes', (data) => {
            console.log('Escuchando Crear_Imanes');
            this.Crear();
        });

        EventBus.$on('Actualizar_Imanes', (data) => {
            console.log('Escuchando Actualizar_Imanes');
            this.Actualizar();
        });

        EventBus.$on('Modificar_Imanes', (data) => {
            console.log('Escuchando Modificar_Imanes');
            this.Actualizar();
        });
